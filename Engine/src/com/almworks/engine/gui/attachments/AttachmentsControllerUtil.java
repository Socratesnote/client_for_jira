    ...
    private static class DownloadProgressForm implements UIComponentWrapper, ChangeListener {
      ...
      private void showMessage(String message) {
        ...
        private void $$$setupUI$$$() {
            ...
            myState = new JLabel();
            myState.setText("Label");
            CellConstraints cc = new CellConstraints();
            myWholePanel.add(myState, cc.xy(1, 1));
            myProgressBar = new JProgressBar();
            myWholePanel.add(myProgressBar, cc.xy(3, 1, CellConstraints.FILL, CellConstraints.DEFAULT));
            myLastMessage = new JLabel();
            myLastMessage.setText("Label");
            myLastMessage.setVisible(true);
            myWholePanel.add(myLastMessage, cc.xyw(1, 3, 3));
        }
