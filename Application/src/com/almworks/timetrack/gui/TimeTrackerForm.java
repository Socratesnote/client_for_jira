...
public class TimeTrackerForm implements UIComponentWrapper {
    ...
    private void $$$setupUI$$$() {
        ...
        myWholePanel.setLayout(new FormLayout("fill:d:grow", "center:max(d;10dlu):noGrow,center:max(d;10dlu):noGrow,top:4dlu:noGrow,center:max(d;10dlu):noGrow,top:4dlu:noGrow,center:d:grow,top:4dlu:noGrow,center:max(d;4px):noGrow"));
        myButtonsPlace = new JPanel();
        myButtonsPlace.setLayout(new BorderLayout(0, 0));
        CellConstraints cc = new CellConstraints();
        myWholePanel.add(myButtonsPlace, cc.xy(1, 2, CellConstraints.DEFAULT, CellConstraints.FILL));
        myCurrentIssuePlace = new JPanel();
        myCurrentIssuePlace.setLayout(new BorderLayout(0, 0));
        myWholePanel.add(myCurrentIssuePlace, cc.xy(1, 4, CellConstraints.DEFAULT, CellConstraints.FILL));
        myCommentsScrollPane = new JScrollPane();
        myCommentsScrollPane.setHorizontalScrollBarPolicy(31);
        myWholePanel.add(myCommentsScrollPane, cc.xy(1, 6, CellConstraints.FILL, CellConstraints.FILL));
        myComments = new JTextArea();
        myComments.setLineWrap(true);
        myComments.setWrapStyleWord(true);
        myCommentsScrollPane.setViewportView(myComments);
        myWholePanel.add(myToolbar, cc.xy(1, 8));
        myTimeSelectorPlace = new JPanel();
        myTimeSelectorPlace.setLayout(new BorderLayout(0, 0));
        myWholePanel.add(myTimeSelectorPlace, cc.xy(1, 1, CellConstraints.DEFAULT, CellConstraints.FILL));
    }
