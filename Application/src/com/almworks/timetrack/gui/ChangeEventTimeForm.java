...
//    });
    ...
    private void $$$setupUI$$$() {
        ...
        myWholePanel.setLayout(new FormLayout("fill:max(d;4px):noGrow,left:4dlu:noGrow,fill:d:grow,left:4dlu:noGrow,fill:max(d;4px):noGrow,left:4dlu:noGrow,fill:d:grow", "center:max(d;4px):noGrow,top:4dlu:noGrow,center:max(d;4px):noGrow,top:4dlu:noGrow,center:max(d;4px):noGrow,top:3dlu:noGrow,center:max(d;4px):noGrow,center:4dlu:noGrow,center:max(d;4px):noGrow"));
        myWholePanel.setFocusCycleRoot(true);
        mySlider.setPaintLabels(true);
        mySlider.setPaintTicks(false);
        mySlider.setPaintTrack(true);
        mySlider.setValueIsAdjusting(false);
        mySlider.putClientProperty("JSlider.isFilled", Boolean.FALSE);
        mySlider.putClientProperty("Slider.paintThumbArrowShape", Boolean.TRUE);
        mySlider.putClientProperty("html.disable", Boolean.TRUE);
        CellConstraints cc = new CellConstraints();
        myWholePanel.add(mySlider, cc.xyw(1, 3, 7, CellConstraints.FILL, CellConstraints.DEFAULT));
        myTimeLabel = new JLabel();
        myTimeLabel.setText("From:");
        myTimeLabel.setDisplayedMnemonic('F');
        myTimeLabel.setDisplayedMnemonicIndex(0);
        myWholePanel.add(myTimeLabel, cc.xy(1, 5));
        myTimePlace = new DesignPlaceHolder();
        myTimePlace.setDesignRows(1);
        myWholePanel.add(myTimePlace, cc.xy(3, 5, CellConstraints.DEFAULT, CellConstraints.CENTER));
        final JLabel label1 = new JLabel();
        label1.setText("Time spent:");
        label1.setDisplayedMnemonic('T');
        label1.setDisplayedMnemonicIndex(0);
        myWholePanel.add(label1, cc.xy(5, 5));
        mySpentPlace = new DesignPlaceHolder();
        mySpentPlace.setDesignRows(1);
        myWholePanel.add(mySpentPlace, cc.xy(7, 5, CellConstraints.DEFAULT, CellConstraints.CENTER));
        final JPanel panel1 = new JPanel();
        panel1.setLayout(new FormLayout("fill:d:grow,left:4dlu:noGrow,fill:max(d;4px):noGrow,left:4dlu:noGrow,fill:max(d;4px):noGrow", "center:d:noGrow"));
        ((FormLayout) panel1.getLayout()).setColumnGroups(new int[][]{new int[]{3, 5}});
        myWholePanel.add(panel1, cc.xyw(1, 9, 7));
        ...
        myHeadLabel = new JLabel();
        myHeadLabel.setText("Adjust start of the current work time period:");
        myWholePanel.add(myHeadLabel, cc.xyw(1, 1, 7));
        final JLabel label2 = new JLabel();
        label2.setText("Adjustments:");
        myWholePanel.add(label2, cc.xy(1, 7, CellConstraints.DEFAULT, CellConstraints.TOP));
        myAdditionalInfo = new JLabel();
        myAdditionalInfo.setPreferredSize(new Dimension(33, 50));
        myAdditionalInfo.setText("Label");
        myAdditionalInfo.setVerticalAlignment(1);
        myWholePanel.add(myAdditionalInfo, cc.xyw(3, 7, 5));
    }
