    ...
    private class ImportingDialog extends JDialog {
      ...
      public void setErrors(List<String> errors) {
        ...
        private void $$$setupUI$$$() {
            ...
            myWholePanel.setLayout(new FormLayout("fill:d:grow", "center:d:noGrow,top:4dlu:noGrow,center:d:grow"));
            myProgressBar = new JProgressBar();
            myProgressBar.setString("Importing");
            myProgressBar.setStringPainted(true);
            CellConstraints cc = new CellConstraints();
            myWholePanel.add(myProgressBar, cc.xy(1, 1, CellConstraints.FILL, CellConstraints.DEFAULT));
            myErrorScrollpane = new JScrollPane();
            myWholePanel.add(myErrorScrollpane, cc.xy(1, 3, CellConstraints.FILL, CellConstraints.FILL));
            myErrorArea = new JTextArea();
            myErrorArea.setColumns(20);
            myErrorArea.setLineWrap(true);
            myErrorArea.setOpaque(true);
            myErrorArea.setRows(8);
