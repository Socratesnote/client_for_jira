...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        myWholePanel.setLayout(new FormLayout("fill:d:noGrow,left:4dlu:noGrow,fill:max(d;4px):noGrow", "center:d:grow"));
        final JLabel label1 = new JLabel();
        label1.setText("Order By:");
        CellConstraints cc = new CellConstraints();
        myWholePanel.add(label1, cc.xy(1, 1));
        myField = new FieldWithMoreButton();
        myField.setActionName("Change ordering field");
        myField.setFieldClassName("javax.swing.JTextField");
        myWholePanel.add(myField, cc.xy(3, 1, CellConstraints.LEFT, CellConstraints.DEFAULT));
    }
