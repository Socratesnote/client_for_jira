    ...
    private static class Form {
      ...
      public static void prepareEdit(VersionSource source, EditItemModel model, EditPrepare editPrepare) {
        ...
        private void $$$setupUI$$$() {
            ...
            myWholePanel.setLayout(new FormLayout("fill:d:noGrow,left:4dlu:noGrow,fill:d:grow", "center:d:grow,top:4dlu:noGrow,center:d:noGrow"));
            final JLabel label1 = new JLabel();
            label1.setText("Comment visible to:");
            CellConstraints cc = new CellConstraints();
            myWholePanel.add(label1, cc.xy(1, 3));
            myVisibleTo = new AComboBox();
            myWholePanel.add(myVisibleTo, cc.xy(3, 3));
