...
class ResolveCommentForm {
    ...
    private ResolveCommentForm(AList<SlaveMergeValue<MergeCommentVersion>> allComments) {
        ...
        if (myAllComments != null)
            for (SlaveMergeValue<MergeCommentVersion> comment : myAllComments.getCollectionModel().toList())
                initResolution(comment);
        ...
        if (resolution != null && resolutionKind != SlaveMergeValue.ResolutionKind.UNRESOLVED) {
            ...
            switch (resolutionKind) {
                ...
                case EDIT:
                    ...
                    break;
                case COPY_NEW:
                    resolutionText = "<Converted to new comment>";
                    break;
                case DELETE:
                    myLocalText.setEnabled(false);
                    myLocalVisibleTo.setEnabled(false);
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        myWholePanel.setLayout(new FormLayout("fill:d:grow,left:4dlu:noGrow,fill:d:grow", "center:max(d;4px):noGrow,top:4dlu:noGrow,center:max(d;4px):noGrow,top:4dlu:noGrow,center:max(d;4px):noGrow,top:4dlu:noGrow,center:d:grow,top:4dlu:noGrow,center:max(d;4px):noGrow,top:4dlu:noGrow,center:max(d;4px):noGrow"));
        ((FormLayout) myWholePanel.getLayout()).setColumnGroups(new int[][]{new int[]{1, 3}});
        final JScrollPane scrollPane1 = new JScrollPane();
        CellConstraints cc = new CellConstraints();
        myWholePanel.add(scrollPane1, cc.xy(1, 7, CellConstraints.FILL, CellConstraints.FILL));
        myLocalText = new ATextArea();
        myLocalText.setColumns(40);
        myLocalText.setLineWrap(true);
        myLocalText.setRows(7);
        myLocalText.setWrapStyleWord(true);
        scrollPane1.setViewportView(myLocalText);
        final JScrollPane scrollPane2 = new JScrollPane();
        myWholePanel.add(scrollPane2, cc.xy(3, 7, CellConstraints.FILL, CellConstraints.FILL));
        myRemoteText = new ATextArea();
        myRemoteText.setColumns(40);
        myRemoteText.setEditable(false);
        myRemoteText.setLineWrap(true);
        myRemoteText.setRows(7);
        myRemoteText.setWrapStyleWord(true);
        scrollPane2.setViewportView(myRemoteText);
        myCommentSummary = new JLabel();
        myCommentSummary.setText("Comment #2 by Author at 01.01.2011");
        myWholePanel.add(myCommentSummary, cc.xyw(1, 1, 3));
        final JLabel label1 = new JLabel();
        label1.setText("Remote version:");
        label1.setDisplayedMnemonic('R');
        label1.setDisplayedMnemonicIndex(0);
        myWholePanel.add(label1, cc.xy(3, 3));
        myRemoteInfo = new ALabel();
        myRemoteInfo.setText("by user at 01.01.2011");
        myWholePanel.add(myRemoteInfo, cc.xy(3, 5));
        final JLabel label2 = new JLabel();
        label2.setText("Local version:");
        label2.setDisplayedMnemonic('L');
        label2.setDisplayedMnemonicIndex(0);
        myWholePanel.add(label2, cc.xy(1, 3));
        myResolutionState = new ALabel();
        myResolutionState.setText("<Concurrent Edit>");
        myWholePanel.add(myResolutionState, cc.xy(1, 5));
        myLocalVisibleTo = new AComboBox();
        myWholePanel.add(myLocalVisibleTo, cc.xy(1, 11));
        final JLabel label3 = new JLabel();
        label3.setText("Visible to:");
        myWholePanel.add(label3, cc.xyw(1, 9, 3));
        myRemoteVisibleTo = new JLabel();
        myRemoteVisibleTo.setText("");
        myWholePanel.add(myRemoteVisibleTo, cc.xy(3, 11));
        label1.setLabelFor(myRemoteText);
        label2.setLabelFor(myLocalText);
    }
