    ...
    private static class CantLoginForm {
      ...
      private void setConnection(String connectionName, String baseUrl) {
        ...
        private void $$$setupUI$$$() {
            ...
            myWholePanel.setLayout(new FormLayout("fill:d:noGrow,left:4dlu:noGrow,fill:d:grow", "center:d:grow,top:4dlu:noGrow,center:d:noGrow,top:4dlu:noGrow,center:max(d;4px):noGrow"));
            ...
            myWholePanel.add(label2, cc.xy(1, 5));
            myAccount = new JTextField();
            myAccount.setEditable(false);
            myWholePanel.add(myAccount, cc.xy(3, 5, CellConstraints.FILL, CellConstraints.DEFAULT));
            myConnectionLink = new URLLink();
            myWholePanel.add(myConnectionLink, cc.xy(3, 3, CellConstraints.LEFT, CellConstraints.DEFAULT));
            final JScrollPane scrollPane1 = new JScrollPane();
            scrollPane1.setHorizontalScrollBarPolicy(31);
            scrollPane1.setVerticalScrollBarPolicy(21);
            myWholePanel.add(scrollPane1, cc.xyw(1, 1, 3, CellConstraints.FILL, CellConstraints.FILL));
            myDescription = new JTextArea();
            myDescription.setColumns(45);
