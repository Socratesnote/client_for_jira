    ...
    private static class AnisotropicPanel implements HierarchyType {
      ...
      public void addChangeListener(Lifespan life, ChangeListener listener) {
        ...
        private void $$$setupUI$$$() {
            ...
            myWholePanel.setLayout(new FormLayout("fill:22dlu:noGrow,fill:max(d;4px):grow", "center:25px:noGrow,center:max(d;4px):noGrow,center:max(d;4px):noGrow"));
            myWholePanel.setOpaque(false);
            myEnabled = new JCheckBox();
            myEnabled.setOpaque(false);
            myEnabled.setText("CheckBox");
            CellConstraints cc = new CellConstraints();
            myWholePanel.add(myEnabled, cc.xyw(1, 1, 2));
            myInward = new JRadioButton();
            myInward.setOpaque(false);
            myInward.setText("RadioButton");
            myWholePanel.add(myInward, cc.xy(2, 3));
            myOutward = new JRadioButton();
            myOutward.setOpaque(false);
            myOutward.setText("RadioButton");
            myWholePanel.add(myOutward, cc.xy(2, 2));
            ButtonGroup buttonGroup;
            buttonGroup = new ButtonGroup();
            buttonGroup.add(myOutward);
            buttonGroup.add(myInward);
        }
